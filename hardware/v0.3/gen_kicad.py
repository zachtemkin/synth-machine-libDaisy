...
def write_schematic():
    ...
    out = ['(kicad_sch (version 20231120) (generator "synth_machine_gen") (generator_version "8.0")',
           ...
           '  (title_block (title "synthMachine carrier board") (rev "0.1-stub") (company "") (comment 1 "Generated by hardware/v0.3/gen_kicad.py - edit freely, or edit the generator and re-run"))']
    # lib_symbols
    libs = {}
    for p in PARTS:
