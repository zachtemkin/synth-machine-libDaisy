...
Run with KiCad's bundled Python (needs pcbnew):
  ...
  $KICAD_PY hardware/v0.4/route.py --java /path/to/java --jar /path/to/freerouting.jar [--passes 100]
  $KICAD_PY hardware/v0.4/route.py --pours-only        # keep the tracks, just rebuild the GND pours
